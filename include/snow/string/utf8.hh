...
/*==============================================================================
  utf8::before
    ...
    is not bounds-checked (i.e., doesn't test for whether it's before the start
    of a sequence), so using it is only valid when there is a valid code
    preceding the iterator.
